...
try{return (java.lang.String)this.h.invoke(this,getName,null);
}catch (Throwable throwable) {throw new UndeclaredThrowableException(throwable);}
}
public void findLive(){
try{this.h.invoke(this,findLive,null);
}catch (Throwable throwable) {throw new UndeclaredThrowableException(throwable);}
}
public java.lang.String getSex(){
try{return (java.lang.String)this.h.invoke(this,getSex,null);
}catch (Throwable throwable) {throw new UndeclaredThrowableException(throwable);}
}
static { try{
